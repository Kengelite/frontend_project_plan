          ...
          <div style={{ padding: "5px" }}>
            <button
              ...
              onClick={() => {
                ...
                // เปลี่ยนหน้า
                window.location.href = `/superadmin/projectresponsible/project/${row.project.project_number}`;
              }}
            >
          ...
          <div style={{ padding: "5px" }}>
            <button
              ...
              onClick={() => {
                ...
                // เปลี่ยนหน้า
                window.location.href = `/superadmin/strategic/${row.project.strategic_number}`;
              }}
            >
