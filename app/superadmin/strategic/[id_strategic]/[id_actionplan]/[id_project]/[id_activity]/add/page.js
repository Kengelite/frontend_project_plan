  ...
  useEffect(() => {
    ...
    try {
      if (
        ...
        setParsedStrategic(parsedStrategicData);
        setParsedActionplan(parsedActionplanData);
          ...
          if (response) {
            Swal.fire({
              ...
              .then(() => {
                ...
                setParsedStrategic(updatedStrategic);
                setParsedActionplan(updatedActionplan);
