...
import { GetDataactionplanByidproject } from "../../../fetch_api/fetch_api_superadmin"; // ปรับ path ตามจริง
          ...
          <div style={{ padding: "5px" }}>
            <button
              ...
              onClick={() => {
                ...
                // เปลี่ยนหน้า
                window.location.href = `/superadmin/projectresponsible/project/${id_project}/${row.id}`;
              }}
            >
